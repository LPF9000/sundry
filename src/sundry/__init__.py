"""sundry: a reusable, config-driven daily news digest builder.
...
archive entry. See ``sundry.cli`` for the entry point and
...
and this repo ships no default topic. Run ``sundry init`` in
